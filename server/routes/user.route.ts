...
import { activateUser, deleteUser, fetchAllUsers, getUserInfo, LoginUser, logoutUser, registrationUser, socialAuth, updateAccessToken, updatePassword, updateProfilePicture, updateRole, updateUserInfo } from "../controllers/user.controller";
